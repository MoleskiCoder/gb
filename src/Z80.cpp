...
void Z80::installInstructions() {
	instructions = {
		...
		/* 3 */	INS(BIND(jrnc), Relative, "JR NC,%3$04XH", 7),	INS(BIND(lxi_sp), Absolute, "LD BC,%2$04XH", 10),	INS(BIND(sta), Absolute, "LD (%2$04XH),A ", 13),	INS(BIND(inx_sp), Implied, "INC SP", 5),			INS(BIND(inr_m), Implied, "INC (HL)", 10),			INS(BIND(dcr_m), Implied, "DEC (HL)", 10),		INS(BIND(mvi_m), Immediate, "LD (HL),%1$02XH", 10),	INS(BIND(stc), Implied, "SCF", 4),				INS(BIND(jrc), Relative, "JR C,%3$04XH", 7),	INS(BIND(dad_sp), Implied, "ADD HL,SP", 10),	INS(BIND(lda), Absolute, "LD A,(%2$04XH)", 13),		INS(BIND(dcx_sp), Implied, "DEC SP", 5),		INS(BIND(inr_a), Implied, "INC A", 5),				INS(BIND(dcr_a), Implied, "DEC A", 5),			INS(BIND(mvi_a), Immediate, "LD A,%1$02XH", 7),	INS(BIND(cmc), Implied, "CCF", 4),			//	3
		...
		/* E */	INS(BIND(rpo), Implied, "RET PO", 5),			INS(BIND(pop_h), Implied, "POP HL", 10),			INS(BIND(jpo), Absolute, "JP PO,%2$04XH", 10),		INS(BIND(xhtl),	Implied, "EX (SP),HL", 18),			INS(BIND(cpo), Absolute, "CALL PO,%2$04XH", 11),	INS(BIND(push_h), Implied, "PUSH HL", 11),		INS(BIND(ani), Immediate, "AND %1$02XH", 7),		INS(BIND(rst_4), Implied, "RST 20H", 11),		INS(BIND(rpe), Implied, "RET PE", 11),			INS(BIND(pchl), Implied, "JP (HL)", 5),			INS(BIND(jpe), Absolute, "JP PE,%2$04XH", 10),		INS(BIND(xchg), Implied, "EX DE,HL", 4),		INS(BIND(cpe), Absolute, "CALL PE,%2$04XH", 11),	INS(BIND(ed), Unknown, "", 0),					INS(BIND(xri), Immediate, "XOR %1$02XH", 7),	INS(BIND(rst_5), Implied, "RST 28H", 11),	//	E

...
void Z80::installInstructionsED() {
	extendedInstructions[0xed] = {
		...
		/* 4 */	INS(BIND(in_b_c), Implied, "IN B,(C)", 12),		INS(BIND(out_c_b), Implied, "OUT (C),B", 12),		INS(BIND(sbc_hl_bc), Implied, "SBC HL,BC", 15),		UNKNOWN(),											UNKNOWN(),											UNKNOWN(),										INS(BIND(im_0), Implied, "IM 0", 8),				INS(BIND(mov_i_a), Implied, "LD I,A", 9),		UNKNOWN(),										UNKNOWN(),										UNKNOWN(),											UNKNOWN(),												UNKNOWN(),											UNKNOWN(),										UNKNOWN(),													UNKNOWN(),									//	4
		/* 5 */	INS(BIND(in_d_c), Implied, "IN D,(C)", 12),		INS(BIND(out_c_d), Implied, "OUT (C),D", 12),		INS(BIND(sbc_hl_de), Implied, "SBC HL,DE", 15),		UNKNOWN(),											UNKNOWN(),											UNKNOWN(),										INS(BIND(im_1), Implied, "IM 1", 8),				UNKNOWN(),										UNKNOWN(),										UNKNOWN(),										UNKNOWN(),											UNKNOWN(),												UNKNOWN(),											UNKNOWN(),										INS(BIND(im_2), Implied, "IM 2", 8),						UNKNOWN(),									//	5
		/* 6 */	INS(BIND(in_h_c), Implied, "IN H,(C)", 12),		INS(BIND(out_c_h), Implied, "OUT (C),H", 12),		INS(BIND(sbc_hl_hl), Implied, "SBC HL,HL", 15),		UNKNOWN(),											UNKNOWN(),											UNKNOWN(),										INS(BIND(im_0), Implied, "IM 0", 8),				UNKNOWN(),										UNKNOWN(),										UNKNOWN(),										UNKNOWN(),											UNKNOWN(),												UNKNOWN(),											UNKNOWN(),										UNKNOWN(),													UNKNOWN(),									//	6
		/* 7 */	UNKNOWN(),										UNKNOWN(),											INS(BIND(sbc_hl_sp), Implied, "SBC HL,SP", 15),		INS(BIND(mov_m_sp), Absolute, "LD (%2$04XH),SP", 20),UNKNOWN(),											UNKNOWN(),										INS(BIND(im_1), Implied, "IM 1", 8),				UNKNOWN(),										UNKNOWN(),										UNKNOWN(),										UNKNOWN(),											INS(BIND(mov_sp_m), Absolute, "LD SP,(%2$04XH)", 20),	UNKNOWN(),											UNKNOWN(),										INS(BIND(im_2), Implied, "IM 2", 8),						UNKNOWN(),									//	7

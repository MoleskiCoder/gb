...
void Z80::installInstructions() {
	instructions = {
		...
		/* E */	INS(BIND(rpo), Implied, "RET PO", 5),			INS(BIND(pop_h), Implied, "POP HL", 10),			INS(BIND(jpo), Absolute, "JP PO,%2$04XH", 10),		INS(BIND(xhtl),	Implied, "EX (SP),HL", 18),			INS(BIND(cpo), Absolute, "CALL PO,%2$04XH", 11),	INS(BIND(push_h), Implied, "PUSH HL", 11),		INS(BIND(ani), Immediate, "AND %1$02XH", 7),		INS(BIND(rst_4), Implied, "RST 20H", 11),		INS(BIND(rpe), Implied, "RET PE", 11),			INS(BIND(pchl), Implied, "JP (HL)", 5),			INS(BIND(jpe), Absolute, "JP PE,%2$04XH", 10),		INS(BIND(xchg), Implied, "EX DE,HL", 4),		INS(BIND(cpe), Absolute, "CALL PE,%2$04XH", 11),	UNKNOWN()/*INS(BIND(ed), Unknown, "", 0)*/,		INS(BIND(xri), Immediate, "XOR %1$02XH", 7),	INS(BIND(rst_5), Implied, "RST 28H", 11),	//	E
...
void Z80::installInstructionsDD() {
	extendedInstructions[0xdd] = {
		...
		/* E */	UNKNOWN(),										INS(BIND(pop_ix), Implied, "POP IX", 14),			UNKNOWN(),											UNKNOWN(),											UNKNOWN(),											INS(BIND(push_ix), Implied, "PUSH IX", 15),		UNKNOWN(),											UNKNOWN(),										UNKNOWN(),										UNKNOWN(),										UNKNOWN(),											UNKNOWN(),										UNKNOWN(),											UNKNOWN(),										UNKNOWN(),										UNKNOWN(),									//	E
...
void Z80::installInstructionsFD() {
	extendedInstructions[0xfd] = {
		...
		/* C */	UNKNOWN(),										UNKNOWN(),											UNKNOWN(),											UNKNOWN(),											UNKNOWN(),											UNKNOWN(),										UNKNOWN(),											UNKNOWN(),										UNKNOWN(),										UNKNOWN(),										UNKNOWN(),											UNKNOWN(),										UNKNOWN(),											UNKNOWN(),										UNKNOWN(),										UNKNOWN(),									//	C
		/* D */	UNKNOWN(),										UNKNOWN(),											UNKNOWN(),											UNKNOWN(),											UNKNOWN(),											UNKNOWN(),										UNKNOWN(),											UNKNOWN(),										UNKNOWN(),										UNKNOWN(),										UNKNOWN(),											UNKNOWN(),										UNKNOWN(),											UNKNOWN(),										UNKNOWN(),										UNKNOWN(),									//	D
		/* E */	UNKNOWN(),										INS(BIND(pop_iy), Implied, "POP IY", 14),			UNKNOWN(),											UNKNOWN(),											UNKNOWN(),											INS(BIND(push_iy), Implied, "PUSH IY", 15),		UNKNOWN(),											UNKNOWN(),										UNKNOWN(),										UNKNOWN(),										UNKNOWN(),											UNKNOWN(),										UNKNOWN(),											UNKNOWN(),										UNKNOWN(),										UNKNOWN(),									//	E
		/* F */	UNKNOWN(),										UNKNOWN(),											UNKNOWN(),											UNKNOWN(),											UNKNOWN(),											UNKNOWN(),										UNKNOWN(),											UNKNOWN(),										UNKNOWN(),										UNKNOWN(),										UNKNOWN(),											UNKNOWN(),										UNKNOWN(),											UNKNOWN(),										UNKNOWN(),										UNKNOWN(),									//	F
	};
}

...
void Z80::installInstructions() {
	instructions = {
		...
		/* D */	INS(BIND(rnc), Implied, "RET NC", 5),			INS(BIND(pop_d), Implied, "POP DE", 10),			INS(BIND(jnc), Absolute, "JP NC,%2$04XH", 10),		INS(BIND(out), Immediate, "OUT (%1$02XH),A", 10),	INS(BIND(cnc), Absolute, "CALL NC,%2$04XH", 11),	INS(BIND(push_d), Implied, "PUSH DE", 11),		INS(BIND(sui), Immediate, "SUB %1$02XH", 7),		INS(BIND(rst_2), Implied, "RST 10H", 11),		INS(BIND(rc), Implied, "RET C", 11),		UNKNOWN(),										INS(BIND(jc), Absolute, "JP C,%2$04XH", 10),		INS(BIND(in), Immediate, "IN A,(%1$02XH)", 10),	INS(BIND(cc), Absolute, "CALL C,%2$04XH", 11),		UNKNOWN(),										INS(BIND(sbi), Immediate, "SBC %1$02XH", 7),	INS(BIND(rst_3), Implied, "RST 18H", 11),	//	D
		/* E */	INS(BIND(rpo), Implied, "RET PO", 5),			INS(BIND(pop_h), Implied, "POP HL", 10),			INS(BIND(jpo), Absolute, "JP PO,%2$04XH", 10),		INS(BIND(xhtl),	Implied, "EX (SP),HL", 18),			INS(BIND(cpo), Absolute, "CALL PO,%2$04XH", 11),	INS(BIND(push_h), Implied, "PUSH HL", 11),		INS(BIND(ani), Immediate, "AND %1$02XH", 7),		INS(BIND(rst_4), Implied, "RST 20H", 11),		INS(BIND(rpe), Implied, "RET PE", 11),		INS(BIND(pchl), Implied, "JP (HL)", 5),			INS(BIND(jpe), Absolute, "JP PE,%2$04XH", 10),		INS(BIND(xchg), Implied, "EX DE,HL", 4),		INS(BIND(cpe), Absolute, "CALL PE,%2$04XH", 11),	UNKNOWN(),										INS(BIND(xri), Immediate, "XOR %1$02XH", 7),	INS(BIND(rst_5), Implied, "RST 28H", 11),	//	E

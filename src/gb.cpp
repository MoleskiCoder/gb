...
int main(int, char*[])
{
	...
	computer->plug("games/Dr. Mario (JU) (V1.1).gb");
	...
	//computer->plug("blargg/interrupt_time.gb");			// Hang

	//computer->plug("mooneye/acceptance/add_sp_e_timing.gb");	// Failed
	//computer->plug("mooneye/acceptance/boot_hwio-dmg0.gb");	// Failed
	//computer->plug("mooneye/acceptance/boot_hwio-dmgABCXmgb.gb");	// Failed
	//computer->plug("mooneye/acceptance/boot_hwio-S.gb");	// Failed
	//computer->plug("mooneye/acceptance/boot_regs-dmg0.gb");	// Failed
	//computer->plug("mooneye/acceptance/boot_regs-dmgABCX.gb"); // Passed
	//computer->plug("mooneye/acceptance/boot_regs-mgb.gb");	// Failed
	//computer->plug("mooneye/acceptance/boot_regs-sgb.gb");
	//computer->plug("mooneye/acceptance/boot_regs-sgb2.gb");
	//computer->plug("mooneye/acceptance/call_cc_timing.gb");	// Fail round 1
	//computer->plug("mooneye/acceptance/call_cc_timing2.gb"); // Failed
	//computer->plug("mooneye/acceptance/call_timing.gb");
	//computer->plug("mooneye/acceptance/call_timing2.gb");
	//computer->plug("mooneye/acceptance/div_timing.gb"); // Passed
	//computer->plug("mooneye/acceptance/di_timing-GS.gb"); // Failed round 2
	...
	//computer->plug("mooneye/acceptance/if_ie_registers.gb"); // Passed
	//computer->plug("mooneye/acceptance/intr_timing.gb"); // Failed
	...
	//computer->plug("mooneye/acceptance/rst_timing.gb");	// Failed
	...
	//computer->plug("mooneye/acceptance/gpu/lcdon_write_timing-GS.gb");	// Failed
	//computer->plug("mooneye/acceptance/gpu/stat_irq_blocking.gb");	// Failed mode 1 = intr
	//computer->plug("mooneye/acceptance/gpu/vblank_stat_intr-GS.gb");	// Failed

	//computer->plug("mooneye/acceptance/serial/boot_sclk_align-dmgABCXmgb.gb");

	//computer->plug("mooneye/acceptance/timer/div_write.gb"); // Passed
	//computer->plug("mooneye/acceptance/timer/rapid_toggle.gb");	// Failed
	//computer->plug("mooneye/acceptance/timer/tim00.gb");	// Failed
	//computer->plug("mooneye/acceptance/timer/tim00_div_trigger.gb");	// Failed
	...
	//computer->plug("mooneye/acceptance/timer/tima_write_reloading.gb");	// Failed
	//computer->plug("mooneye/acceptance/timer/tma_write_reloading.gb");	// Failed
